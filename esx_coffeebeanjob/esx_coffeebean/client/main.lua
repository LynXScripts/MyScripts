...
function IsJobTrue()
    if PlayerData ~= nil then
        ...
        if PlayerData.job ~= nil and PlayerData.job.name == 'coffeebean' then
            IsJobTrue = true
        end
        return IsJobTrue
    end
...
function OpenVaultMenu()
    ...
    local elements = {
      {label = "CoffeeBeans (x1) - 50$", value = 'coffeebeans'},
      {label = "Cup (x10) - 60$", value = 'cup'},
      {label = "Milk (x1) - 60$", value = 'milk'}
    }
    ...
    if data.current.value == "coffee" then
			valor = 2
		end
		...
		TriggerServerEvent('esx_coffeebeanjob:shop', data.current.value, valor)
      end,
...
function OpenCozinharMenu()
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        TriggerServerEvent('esx_coffeebeanjob:craftingCoktails', data.current.value)
    ...
    ESX.TriggerServerCallback('esx_society:getVehiclesInGarage', function(garageVehicles)
      ...
      ESX.UI.Menu.Open(
        ...
        function(data, menu)
          ...
          TriggerServerEvent('esx_society:removeVehicleFromGarage', 'coffeebean', vehicleProps)
...
function OpenSocietyActionsMenu()
  ...
  ESX.UI.Menu.Open(
    'default', GetCurrentResourceName(), 'coffeebean_actions',
    {
      title    = "Billing",
      align    = 'top-left',
      elements = elements
  ...
  ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'billing', {
    ...
    if amount == nil or amount < 0 then
      ...
      if closestPlayer == -1 or closestDistance > 3.0 then
        ...
        menu.close()
        TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(closestPlayer), 'society_coffeebean', _U('coffeebean'), amount)
      end
    end
...
function OpenGetStocksMenu()
  ...
  ESX.TriggerServerCallback('esx_coffeebeanjob:getStockItems', function(items)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_coffeebeanjob:getStockItem', itemName, count)
            end
...
ESX.TriggerServerCallback('esx_coffeebeanjob:getPlayerInventory', function(inventory)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_coffeebeanjob:putStockItems', itemName, count)
            end
...
function OpenGetFridgeStocksMenu()
  ...
  ESX.TriggerServerCallback('esx_coffeebeanjob:getFridgeStockItems', function(items)
    ...
    ESX.UI.Menu.Open(
      ...
      {
        title    = _U('coffeebean_fridge_stock'),
        elements = elements
      },
      function(data, menu)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_coffeebeanjob:getFridgeStockItem', itemName, count)
            end
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_coffeebeanjob:putFridgeStockItems', itemName, count)
            end
...
function OpenGetWeaponMenu()
  ...
  ESX.TriggerServerCallback('esx_coffeebeanjob:getVaultWeapons', function(weapons)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        ESX.TriggerServerCallback('esx_coffeebeanjob:removeVaultWeapon', function()
          OpenGetWeaponMenu()
...
function OpenPutWeaponMenu()
  ...
  ESX.UI.Menu.Open(
    ...
    function(data, menu)
      ...
      ESX.TriggerServerCallback('esx_coffeebeanjob:addVaultWeapon', function()
        OpenPutWeaponMenu()
      end, data.current.value)
...
function OpenShopMenu(zone)
    ...
    ESX.UI.Menu.Open(
        'default', GetCurrentResourceName(), 'coffeebean_shop',
        {
            title    = _U('shop'),
            elements = elements
        },
        function(data, menu)
            TriggerServerEvent('esx_coffeebeanjob:buyItem', data.current.value, data.current.price, data.current.realLabel)
        end,
        function(data, menu)
            menu.close()
        end
...
AddEventHandler('esx_coffeebeanjob:hasEnteredMarker', function(zone)
...
AddEventHandler('esx_coffeebeanjob:hasExitedMarker', function(zone)
...
Citizen.CreateThread(function()
    ...
    AddTextComponentString("coffeebean")
    ...
    while true do
        ...
        if IsJobTrue() then
            ...
            if (isInMarker and not HasAlreadyEnteredMarker) or (isInMarker and LastZone ~= currentZone) then
                ...
                TriggerEvent('esx_coffeebeanjob:hasEnteredMarker', currentZone)
            end

            if not isInMarker and HasAlreadyEnteredMarker then
                HasAlreadyEnteredMarker = false
                TriggerEvent('esx_coffeebeanjob:hasExitedMarker', LastZone)
            end
...
Citizen.CreateThread(function()
  while true do
      ...
      if IsControlJustReleased(0,  Keys['E']) and IsJobTrue() then
        ...
        if CurrentAction == 'delete_vehicle' then
          ...
          if Config.EnableSocietyOwnedVehicles then
            ...
            TriggerServerEvent('esx_society:putVehicleInGarage', 'coffeebean', vehicleProps)
            ...
            then
              TriggerServerEvent('esx_service:disableService', 'coffeebean')
            end
        ...
        if CurrentAction == 'menu_boss_actions' and IsGradeBoss() then
          ...
          TriggerEvent('esx_society:openBossMenu', 'coffeebean', function(data, menu)
    ...
    if IsControlJustReleased(0,  Keys['F6']) and IsJobTrue() and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'coffeebean_actions') then
...
RegisterNetEvent('esx_coffeebeanjob:StartCookAnimation')
AddEventHandler('esx_coffeebeanjob:StartCookAnimation', function()
exports['progressBars']:startUI(20000, "Making Cofee")
...
RegisterNetEvent('esx_coffeebeanjob:StopCookAnimation')
AddEventHandler('esx_coffeebeanjob:StopCookAnimation', function()
local ped = GetPlayerPed(-1)
